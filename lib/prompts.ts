...
<<<<<<< HEAD
- key_experiences: Summary of key professional experiences that are most relevant to the role that the individual is applying for
- experience_score: Rate the candidate's experience from 1-10
- summary: Write a 2-sentence professional bio`,

  RESEARCH_EXTRACT: `You are a research assistant helping a university student tailor outreach.
...
Extract names of any founders, executives, or team leads mentioned, especially in the target role that the user is aiming for, if possible.`,
=======
- experience_score: Rate the candidate's experience from 1-10
- summary: Write a 2-sentence professional bio`,
...
<<<<<<< HEAD
- MOST IMPORTANT!!!!! : HUMANIFY THE TEXT, DON'T MAKE IT SOUND LIKE IT WAS GENERATED BY AI, BUT KEEP A LEVEL OF PROFESSIONALISM.
- Tailor the email specifically to the TARGET ROLE the candidate is applying for.
- Connect user experiences that are understood from the resume data to the startup's needs, and VERY SPECIFIC projects/aims/mission of the company, showing his/her ability to fit in and contribute.
- Max 130-150 words, and paragraph the email well. Keep it formal btu friednly, as if you are the student.`,
=======
